    ...
    public class MessageInfoServiceBD : IMessageInfoService
    {
        ...
        public List<MessageInfoViewModel> GetList()
        {
            List<MessageInfoViewModel> result = context.MessageInfos
                .Where(rec => !rec.ZakazchikId.HasValue)
        ...
        {
            MessageInfo element = context.MessageInfos.Include(rec => rec.Zakazchik)
            ...
            if (element != null)
            {
                return new MessageInfoViewModel
                {
                    ...
                    ClientName = element.Zakazchik.ZakazchikFIO,
        ...
        public void AddElement(MessageInfoBindingModel model)
        {
            ...
            {
                var Zakazchik = context.Zakazchiks.FirstOrDefault(rec => rec.Mail == mailAddress.Value);
                if (Zakazchik != null)
                {
                    message.ZakazchikId = Zakazchik.Id;
                }
            }
